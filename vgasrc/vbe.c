...
#define VBE_OEM_STRING "WakBIOS VBE(C) 2019"
#define VBE_VENDOR_STRING "WakBIOS Developers"
#define VBE_PRODUCT_STRING "WakBIOS VBE Adapter"
#define VBE_REVISION_STRING "Rev.69"
